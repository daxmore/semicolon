...
<body>
    ...
    <div class="container mx-auto px-4 py-8">
        <!-- Welcome Section -->
        <div class="bg-gradient-to-r from-purple-600 to-indigo-700 text-white rounded-lg shadow-lg p-8 mb-8 text-center">
            <h1 class="text-4xl md:text-5xl font-extrabold mb-4">Welcome Back, <?php echo htmlspecialchars($_SESSION['username']); ?>!</h1>
            <p class="text-lg md:text-xl mb-6">Your personalized hub for academic resources.</p>
            <a href="request.php" class="inline-block bg-white text-purple-700 hover:bg-gray-100 px-8 py-3 rounded-full text-lg font-semibold transition duration-300 ease-in-out shadow-md">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-xl p-6">
                ...
                <ul class="space-y-4">
                    <li class="flex items-center space-x-3">
                        ...
                        <div>
                            <p class="text-gray-800 font-medium">Downloaded: <span class="text-blue-600">Mid-Term Exam 2024</span></p>
                    ...
                    <li class="flex items-center space-x-3">
                        ...
                        <div>
                            <p class="text-gray-800 font-medium">Watched: <span class="text-red-600">PHP for Beginners Tutorial</span></p>
                    ...
                    <li class="flex items-center space-x-3">
                        ...
                        <div>
                            <p class="text-gray-800 font-medium">Viewed: <span class="text-green-600">Introduction to Algorithms</span></p>
            ...
            <div class="bg-white rounded-lg shadow-xl p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <a href="papers.php" class="block bg-blue-50 hover:bg-blue-100 rounded-lg p-4 text-center transition duration-300">
                        <h3 class="font-semibold text-blue-700">Browse Papers</h3>
                        <p class="text-sm text-gray-600">Find research and past exams.</p>
                    </a>
                    <a href="books.php" class="block bg-green-50 hover:bg-green-100 rounded-lg p-4 text-center transition duration-300">
                        <h3 class="font-semibold text-green-700">Explore Books</h3>
                        <p class="text-sm text-gray-600">Discover digital textbooks.</p>
                    </a>
                    <a href="videos.php" class="block bg-red-50 hover:bg-red-100 rounded-lg p-4 text-center transition duration-300">
                        <h3 class="font-semibold text-red-700">Watch Videos</h3>
                        <p class="text-sm text-gray-600">Learn with video tutorials.</p>
                    </a>
                    <a href="request.php" class="block bg-purple-50 hover:bg-purple-100 rounded-lg p-4 text-center transition duration-300">
