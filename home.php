...
<body>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-gradient-to-r from-teal-500 to-blue-600 text-white rounded-lg shadow-lg p-8 mb-8 text-center">
            <h1 class="text-4xl md:text-5xl font-extrabold mb-4">Welcome,
                <?php echo $_SESSION['username'] ?? 'Guest'; ?>!</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div
                ...
                <p class="text-gray-600 mb-4">Dive into a vast collection of academic papers across various subjects and
                    years.</p>
                <a href="papers.php"
                    class="mt-auto inline-block bg-blue-600 text-white hover:bg-blue-700 px-6 py-2 rounded-full text-md font-medium transition duration-300 ease-in-out">
                    View All Papers
                </a>
            </div>
            ...
            <div
                ...
                <p class="text-gray-600 mb-4">Access a curated selection of digital books to enhance your learning
                    experience.</p>
                <a href="books.php"
                    class="mt-auto inline-block bg-green-600 text-white hover:bg-green-700 px-6 py-2 rounded-full text-md font-medium transition duration-300 ease-in-out">
                    Browse Books
                </a>
            </div>
            ...
            <div
                ...
                <p class="text-gray-600 mb-4">Watch insightful videos and tutorials to deepen your understanding of
                    complex topics.</p>
                <a href="videos.php"
                    class="mt-auto inline-block bg-red-600 text-white hover:bg-red-700 px-6 py-2 rounded-full text-md font-medium transition duration-300 ease-in-out">
                    Watch Videos
                </a>
            </div>
        </div>
