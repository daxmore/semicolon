            ...
            <div class="space-y-8">
                ...
                <div class="bg-white rounded-lg shadow-xl p-8">
                    ...
                    <div class="space-y-4 text-gray-700">
                        <p class="flex items-center"><svg xmlns="http://www.w3.org/2000/svg"
                                class="h-6 w-6 mr-3 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg> contact@semicolon.com</p>
                        <p class="flex items-center"><svg xmlns="http://www.w3.org/2000/svg"
                                class="h-6 w-6 mr-3 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            </svg> +1 (123) 456-7890</p>
                        <p class="flex items-center"><svg xmlns="http://www.w3.org/2000/svg"
                                class="h-6 w-6 mr-3 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            </svg> 123 Semicolon Street, Knowledge City, KC 98765</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-xl p-8">
                    ...
                    <div class="aspect-w-16 aspect-h-9">
                        ...
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3721.3364293788463!2d72.7763147!3d21.2099092!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be04c389d7cac09%3A0x3a223c58069f86e2!2sPalanpur%20Jakatnaka%2C%20Surat%2C%20Gujarat%2C%20India!5e0!3m2!1sen!2sin!4v1692452100000!5m2!1sen!"
