                    ...
                    <div class="sticky top-20">
                        ...
                        <div class="space-y-0.5 max-h-[50vh] overflow-y-auto custom-scrollbar pr-2 mb-6">
                            <a href="papers.php<?php echo $year ? '?year='.$year : ''; ?>" 
                               class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition <?php echo !$selected_category ? 'bg-teal-50 dark:bg-teal-900/30 text-teal-700 dark:text-teal-400' : 'text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100/80 dark:hover:bg-zinc-800/50 hover:text-zinc-900 dark:hover:text-zinc-200'; ?>">
                                <div class="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 <?php echo !$selected_category ? 'bg-teal-100/50 dark:bg-teal-400/10 text-teal-600 dark:text-teal-400' : 'text-zinc-400 dark:text-zinc-500 bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-800'; ?>">
                            ...
                            <?php foreach ($categories as $cat): ?>
                                <a href="papers.php?category=<?php echo urlencode($cat); ?><?php echo $year ? '&year='.$year : ''; ?>" 
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition group <?php echo ($selected_category === $cat) ? 'bg-teal-50 dark:bg-teal-900/30 text-teal-700 dark:text-teal-400' : 'text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100/80 dark:hover:bg-zinc-800/50 hover:text-zinc-900 dark:hover:text-zinc-200'; ?>">
                                    <div class="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 <?php echo ($selected_category === $cat) ? 'bg-teal-100/50 dark:bg-teal-400/10 text-teal-600 dark:text-teal-400' : 'text-zinc-400 dark:text-zinc-500 group-hover:text-zinc-500 bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-800'; ?>">
