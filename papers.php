            ...
            <?php foreach ($papers as $paper): ?>
                <div class="block rounded-lg p-4 shadow-sm shadow-indigo-100">
                    <div class="mt-4">
                        ...
                        <p class="mt-2 text-sm text-gray-500">Subject: <?php echo htmlspecialchars($paper['subject']); ?></p>
                        <p class="mt-2 text-sm text-gray-500">Year: <?php echo htmlspecialchars($paper['year']); ?></p>
                        <div class="mt-4">
                            <a href="download_paper.php?id=<?php echo $paper['id']; ?>" class="inline-block rounded bg-indigo-600 px-4 py-2 text-xs font-medium text-white hover:bg-indigo-700">Download</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
