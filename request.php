...
<body>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <?php if ($message): ?>
            <div id="alertMessage" class="<?php echo $message_type === 'success' ? 'bg-green-100 border-green-400 text-green-700' : 'bg-red-100 border-red-400 text-red-700'; ?> border px-4 py-3 rounded relative mb-6"
                role="alert">
                <span class="block sm:inline"><?php echo htmlspecialchars($message); ?></span>
                <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
                    <svg class="fill-current h-6 w-6 <?php echo $message_type === 'dark' ? 'text-green-500' : 'text-red-500'; ?>" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" onclick="document.getElementById('alertMessage').style.display='none';">
                        <title>Close</title>
