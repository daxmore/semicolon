...
import { Search, FileText, ChevronRight, Sparkles, Filter, Calendar, AlertCircle } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mb-10 text-center sm:text-left flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 border-b border-zinc-200 pb-8">
        <div>
          ...
          <p className="mt-2 text-xs text-zinc-500 max-w-xl">
            Seminal computer science papers, distributed systems whitepapers, and exam archives.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-2xl border border-zinc-200/80 shadow-sm mb-8 space-y-4">
        <div className="flex flex-col md:flex-row gap-4 items-stretch md:items-center justify-between">
          ...
          <div className="relative flex-1">
            ...
            <input
              type="text"
              placeholder="Search research papers by title or topic..."
              value={searchTerm}
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-1.5 rounded-xl border border-zinc-200 bg-zinc-50 text-xs font-semibold text-zinc-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600"
            >
              {YEARS.map((y) => (
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16 bg-white rounded-2xl border border-zinc-200 p-8 space-y-3">
          ...
          <h3 className="text-sm font-bold text-zinc-900">No papers found</h3>
          <p className="text-xs text-zinc-500 max-w-sm mx-auto">
            Try adjusting your search query or publication year.
          </p>
        </div>
      )}
    </div>
