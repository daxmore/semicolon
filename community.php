...
// Build query
$sql = "SELECT cp.*, u.username, u.is_pro";
                                ...
                                <article class="bg-white border border-zinc-200 rounded-xl hover:border-zinc-300 transition-colors duration-200 overflow-hidden shadow-sm flex">
                                    ...
                                    <div class="flex-1 p-2 sm:p-4 min-w-0">
                                        ...
                                        <div class="flex items-center gap-1.5 text-[13px] mb-2 px-2 sm:px-0">
                                            ...
                                            <span class="text-zinc-500 font-medium hover:underline hover:text-zinc-900 cursor-pointer flex items-center gap-1">
                                                <?php echo htmlspecialchars($post['username']); ?>
                                                <?php if (isset($post['is_pro']) && $post['is_pro']): ?>
                                        ...
                                        <div class="flex items-center gap-1 mt-1 px-1 sm:px-0">
                                            ...
                                            <button onclick="handleListVote(<?php echo $post['id']; ?>, 'downvote')" id="mobile-list-downvote-<?php echo $post['id']; ?>" class="flex sm:hidden items-center p-1 rounded transition group <?php echo $has_downvoted ? 'text-blue-500 font-bold' : 'text-zinc-400 hover:text-blue-500'; ?> mr-2">
