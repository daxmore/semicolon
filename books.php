        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-64 flex-shrink-0">
                    <div class="sticky top-24 bg-white rounded-2xl border border-zinc-100 p-6 shadow-sm">
                        <div class="mb-6">
                            ...
                            <div class="space-y-2">
                                <a href="books.php" class="block w-full text-left px-4 py-2.5 rounded-xl text-sm font-medium transition <?php echo !$subject ? 'bg-indigo-50 text-indigo-700' : 'text-zinc-600 hover:bg-zinc-50 hover:text-zinc-900'; ?>">
                                    All Subjects
                                </a>
                                <?php foreach ($subjects as $s): ?>
                                    <a href="books.php?subject=<?php echo urlencode($s); ?>" 
                                       class="block w-full text-left px-4 py-2.5 rounded-xl text-sm font-medium transition <?php echo ($subject === $s) ? 'bg-indigo-50 text-indigo-700' : 'text-zinc-600 hover:bg-zinc-50 hover:text-zinc-900'; ?>">
                        ...
                        <div class="pt-6 border-t border-zinc-100">
                            <div class="flex items-center justify-between text-sm text-zinc-500 mb-2">
                                <span>Results</span>
                                <span class="font-medium text-zinc-900 bg-zinc-100 px-2 py-0.5 rounded-md"><?php echo count($books); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
