...
<div class="mb-8 px-4 sm:px-0">
    <a href="papers.php" class="inline-flex items-center gap-2 text-zinc-500 dark:text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-200 font-medium transition group">
...
<div class="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 p-8 shadow-xl max-w-4xl mx-auto lg:mx-0">
    <h2 class="text-xl font-black text-zinc-900 dark:text-white mb-8 tracking-tight">Edit Paper Details</h2>
    ...
    <form action="papers.php" method="post" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="title" value="<?php echo htmlspecialchars($paper['title']); ?>" required
                class="w-full px-5 py-3.5 bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700 rounded-2xl text-zinc-900 dark:text-white focus:ring-2 focus:ring-teal-500 outline-none transition shadow-sm">
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-[10px] font-black text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-2 px-1">Year</label>
        ...
        <div class="p-6 bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl border border-zinc-100 dark:border-zinc-800 shadow-inner">
            ...
            <div class="flex items-center gap-3">
                ...
                <p class="text-sm text-zinc-600 dark:text-zinc-300 font-mono text-xs break-all"><?php echo htmlspecialchars($paper['private_path']); ?></p>
            </div>
        </div>
                ...
                <div>
                    ...
                    <label class="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-zinc-300 dark:border-zinc-700 rounded-3xl cursor-pointer bg-zinc-50 dark:bg-zinc-800/30 hover:bg-zinc-100 dark:hover:bg-zinc-800/50 transition shadow-inner group">
                        <div class="flex flex-col items-center justify-center py-5">
                            ...
                            <p class="text-xs text-zinc-500 dark:text-zinc-400 px-4 text-center"><span id="file-name-display" class="font-bold text-teal-600 dark:text-teal-400">Choose new PDF</span></p>
                        </div>
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <input type="url" id="fileUrlInput" name="file_url" placeholder="https://example.com/paper.pdf" 
                            class="w-full px-5 py-4 bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700 rounded-2xl text-zinc-900 dark:text-white font-mono text-xs focus:ring-2 focus:ring-teal-500 outline-none transition shadow-sm">
                        <div class="p-4 bg-cyan-50 dark:bg-cyan-900/10 rounded-2xl border border-cyan-100 dark:border-cyan-900/20">
                            <p class="text-[10px] text-cyan-600 dark:text-cyan-400 font-medium leading-relaxed">
        ...
        <div class="flex items-center justify-end gap-10 pt-10 mt-6 border-t border-zinc-100 dark:border-zinc-800">
            <a href="papers.php" class="text-xs font-black uppercase text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition group">
                Discard Changes
            </a>
    ...
    if (fileInput && urlInput && fileNameDisplay) {
        fileInput.addEventListener('change', function(e) {
            if (e.target.files.length > 0) {
                ...
                fileNameDisplay.innerHTML = `<span class="text-teal-600 dark:text-teal-400 flex items-center justify-center gap-2 font-bold break-all">
