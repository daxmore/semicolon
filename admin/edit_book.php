...
<div class="mb-8 px-4 sm:px-0">
    <a href="books.php" class="inline-flex items-center gap-2 text-zinc-500 hover:text-zinc-700 font-medium transition group">
...
<div class="bg-white rounded-3xl border border-zinc-200 p-8 shadow-xl max-w-4xl mx-auto lg:mx-0">
    <h2 class="text-xl font-black text-zinc-900 mb-8 tracking-tight">Edit Book Details</h2>
    ...
    <form action="books.php" method="post" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-2 px-1">Author</label>
        ...
        <div>
            ...
            <textarea name="description" rows="4" required
                class="w-full px-5 py-3.5 bg-zinc-50 border border-zinc-200 rounded-2xl text-zinc-900 focus:ring-2 focus:ring-indigo-500 outline-none transition shadow-sm"><?php echo htmlspecialchars($book['description']); ?></textarea>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="difficulty" required
                    class="w-full px-5 py-3.5 bg-zinc-50 border border-zinc-200 rounded-2xl text-zinc-900 focus:ring-2 focus:ring-indigo-500 outline-none transition shadow-sm appearance-none">
        ...
        <div class="p-6 bg-zinc-50 rounded-2xl border border-zinc-100 shadow-inner">
            ...
            <div class="flex items-center gap-3">
                ...
                <p class="text-sm text-zinc-600 font-mono text-xs break-all"><?php echo htmlspecialchars($book['private_path']); ?></p>
            </div>
        </div>
                ...
                <div>
                    ...
                    <label class="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-zinc-300 rounded-3xl cursor-pointer bg-zinc-50 hover:bg-zinc-100 transition shadow-inner group">
                        <div class="flex flex-col items-center justify-center py-5">
                            ...
                            <p class="text-xs text-zinc-500 px-4 text-center"><span id="file-name-display" class="font-bold text-indigo-600">Choose new PDF</span></p>
                        </div>
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <input type="url" id="fileUrlInput" name="file_url" placeholder="https://example.com/document.pdf" 
                            class="w-full px-5 py-4 bg-zinc-50 border border-zinc-200 rounded-2xl text-zinc-900 font-mono text-xs focus:ring-2 focus:ring-indigo-500 outline-none transition shadow-sm">
                        <div class="p-4 bg-emerald-50 rounded-2xl border border-emerald-100">
                            <p class="text-[10px] text-emerald-600 font-medium leading-relaxed">
        ...
        <div class="flex items-center justify-end gap-10 pt-10 mt-6 border-t border-zinc-100">
            <a href="books.php" class="text-xs font-black uppercase text-zinc-400 hover:text-zinc-900 transition group flex items-center gap-2">
                Discard Changes
            </a>
    ...
    if (fileInput && urlInput && fileNameDisplay) {
        fileInput.addEventListener('change', function(e) {
            if (e.target.files.length > 0) {
                ...
                fileNameDisplay.innerHTML = `<span class="text-emerald-600 flex items-center justify-center gap-2 font-bold break-all">
