...
<div class="bg-white p-6 rounded-2xl border border-zinc-200 mb-8 shadow-sm">
    ...
    <form action="papers.php" method="post" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="md:col-span-2">
            ...
            <input type="text" name="title" required class="w-full px-4 py-2 bg-white border border-zinc-200 rounded-xl text-zinc-900 focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition">
        </div>
        <div>
            <label class="block text-sm font-medium text-zinc-700 mb-1">Subject</label>
            <input type="text" name="subject" required class="w-full px-4 py-2 bg-white border border-zinc-200 rounded-xl text-zinc-900 focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition">
        </div>
        <div>
            <label class="block text-sm font-medium text-zinc-700 mb-1">Year</label>
            <input type="number" name="year" required min="2000" max="2030" value="<?php echo date('Y'); ?>" class="w-full px-4 py-2 bg-white border border-zinc-200 rounded-xl text-zinc-900 focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition">
        </div>
        ...
        <div class="md:col-span-2 border-t border-zinc-100 pt-4 mt-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="url" id="fileUrlInput" name="file_url" placeholder="https://example.com/paper.pdf" class="w-full px-4 py-3 bg-white border border-zinc-200 rounded-xl text-zinc-900 focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition">
...
<div class="bg-white rounded-2xl border border-zinc-200 overflow-hidden shadow-sm">
    <div class="p-4 border-b border-zinc-100">
        <input type="text" id="searchInput" onkeyup="searchPapers()" placeholder="Search papers..." 
            class="w-full px-4 py-2 bg-zinc-50 border-0 rounded-xl text-zinc-900 focus:ring-2 focus:ring-teal-500 outline-none transition">
    </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <?php if (!empty($paper['private_path'])): ?>
                                        ...
                                        ?>
                                        <a href="<?php echo htmlspecialchars($link); ?>" target="_blank" class="p-2 bg-teal-100 text-teal-600 rounded-lg hover:bg-teal-200 transition" title="View Paper">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
