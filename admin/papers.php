...
<div class="bg-white p-6 rounded-2xl border border-zinc-200 mb-8 shadow-sm">
    ...
    <form action="papers.php" method="post" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <select name="subject" required class="w-full px-4 py-2 bg-white border border-zinc-200 rounded-xl text-zinc-900 focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition">
