...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
        ...
        <div class="glass-panel rounded-2xl p-6 flex items-center gap-6 lg:col-span-2">
            ...
            <div class="flex-1">
                <h1 class="text-2xl font-bold text-zinc-900 tracking-tight mb-1"><?php echo htmlspecialchars($user['username']); ?></h1>
                <p class="text-zinc-500 text-sm font-medium mb-3">Level <?php echo $level; ?> Challenger</p>
                
                <!-- XP Bar -->
                <div class="flex justify-between text-xs text-zinc-500 mb-1 font-medium">
                    <span><?php echo number_format($xp_total); ?> XP</span>
                    <span>Next: <?php echo number_format($xp_for_next_level); ?> XP</span>
                </div>
                <div class="w-full h-3 bg-zinc-100 rounded-full overflow-hidden border border-zinc-200">
        ...
        <div class="glass-panel rounded-2xl p-6 flex flex-col justify-between">
            <div>
                ...
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        <div class="text-2xl font-bold text-zinc-900"><?php echo $streak; ?> Days</div>
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h2 class="text-3xl font-bold text-zinc-900 tracking-tight">Skill Trees</h2>
            <p class="text-zinc-500 mt-1">Conquer challenges to unlock higher tiers and earn certifications.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <?php foreach ($skills_progress as $skill): ?>
            ...
            <a href="skill_detail.php?id=<?php echo $skill_id; ?>" class="rpg-card glass-panel rounded-2xl p-6 relative overflow-hidden group block">
                ...
                <h3 class="text-xl font-bold text-zinc-900 mb-2 relative z-10"><?php echo $skill_name; ?></h3>
                <p class="text-zinc-500 text-sm mb-6 line-clamp-2 relative z-10"><?php echo $skill_desc; ?></p>
